...
public class OthelloState implements State {
	...
	public float heuristic() {
		...
		return this.pieceDifferential() + //总子数
		   8 * this.moveDifferential() + // 可选的行动方式
		  300 * this.cornerDifferential() + // 占角
		   1 * this.stabilityDifferential() + // 稳定子:不会被翻掉
		   winconstant;
		   // 改进方式:加大可选行动方式的系数,加大稳定子的系数
		   //对会玩的和不会玩的区别对待:对手建模
	}
